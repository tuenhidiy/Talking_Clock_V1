...
// TEMPERATURE SPEAKING
  ...
  {
  // THE LIGHT LEVEL SPEAKING
     
    CircuitPlayground.speaker.say(spa_TONE1);
    CircuitPlayground.speaker.say(spPAUSE2);
    CircuitPlayground.speaker.say(sp2_THE);
    CircuitPlayground.speaker.say(sp2_LIGHT);
    CircuitPlayground.speaker.say(sp2_IS);
    CircuitPlayground.speaker.say(spPAUSE1);
    sayNumber(lightvalue);
    CircuitPlayground.speaker.say(spPAUSE1);
    CircuitPlayground.speaker.say(sp2_L);
    CircuitPlayground.speaker.say(sp2_X);
    CircuitPlayground.speaker.say(spa_TONE2);
    CircuitPlayground.speaker.end();
  }   
}
...
void sayNumber(int number)
{
  if (number == 0) 
  {
    CircuitPlayground.speaker.say(sp2_ZERO);
  } 
  else 
  {
    if (number >= 1000) 
    {
      ...
      sayNumber(thousands);
      CircuitPlayground.speaker.say(sp2_THOUSAND);
      number %= 1000;
      if ((number > 0) && (number < 100)) CircuitPlayground.speaker.say(sp2_AND);
    }
    if (number >= 100) 
    {
      int hundreds = number / 100;
      sayNumber(hundreds);
      CircuitPlayground.speaker.say(sp2_HUNDRED);
      number %= 100;
      if (number > 0) CircuitPlayground.speaker.say(sp2_AND);
    }
    if (number > 19) 
    {
      int tens = number / 10;
      switch (tens) 
      {
        case 2: CircuitPlayground.speaker.say(sp2_TWENTY); break;
        case 3: CircuitPlayground.speaker.say(sp2_THIR_); CircuitPlayground.speaker.say(sp2_T); break;
        case 4: CircuitPlayground.speaker.say(sp2_FOUR); CircuitPlayground.speaker.say(sp2_T);  break;
        case 5: CircuitPlayground.speaker.say(sp2_FIF_);  CircuitPlayground.speaker.say(sp2_T); break;
        case 6: CircuitPlayground.speaker.say(sp2_SIX);  CircuitPlayground.speaker.say(sp2_T); break;
        case 7: CircuitPlayground.speaker.say(sp2_SEVEN);  CircuitPlayground.speaker.say(sp2_T); break;
        case 8: CircuitPlayground.speaker.say(sp2_EIGHT);  CircuitPlayground.speaker.say(sp2_T); break;
        case 9: CircuitPlayground.speaker.say(sp2_NINE);  CircuitPlayground.speaker.say(sp2_T); break;
      }
      number %= 10;
    }
    switch(number) 
    {
      case 1: CircuitPlayground.speaker.say(sp2_ONE); break;
      case 2: CircuitPlayground.speaker.say(sp2_TWO); break;
      case 3: CircuitPlayground.speaker.say(sp2_THREE); break;
      case 4: CircuitPlayground.speaker.say(sp2_FOUR); break;
      case 5: CircuitPlayground.speaker.say(sp2_FIVE); break;
      case 6: CircuitPlayground.speaker.say(sp2_SIX); break;
      case 7: CircuitPlayground.speaker.say(sp2_SEVEN); break;
      case 8: CircuitPlayground.speaker.say(sp2_EIGHT); break;
      case 9: CircuitPlayground.speaker.say(sp2_NINE); break;
      case 10: CircuitPlayground.speaker.say(sp2_TEN); break;
      case 11: CircuitPlayground.speaker.say(sp2_ELEVEN); break;
      case 12: CircuitPlayground.speaker.say(sp2_TWELVE); break;
      case 13: CircuitPlayground.speaker.say(sp2_THIR_); CircuitPlayground.speaker.say(sp2__TEEN); break;
      case 14: CircuitPlayground.speaker.say(sp2_FOUR); CircuitPlayground.speaker.say(sp2__TEEN);break;
      case 15: CircuitPlayground.speaker.say(sp2_FIF_); CircuitPlayground.speaker.say(sp2__TEEN); break;
      case 16: CircuitPlayground.speaker.say(sp2_SIX); CircuitPlayground.speaker.say(sp2__TEEN); break;
      case 17: CircuitPlayground.speaker.say(sp2_SEVEN); CircuitPlayground.speaker.say(sp2__TEEN); break;
      case 18: CircuitPlayground.speaker.say(sp2_EIGHT); CircuitPlayground.speaker.say(sp2__TEEN); break;
      case 19: CircuitPlayground.speaker.say(sp2_NINE); CircuitPlayground.speaker.say(sp2__TEEN); break;
    }
  }
}
